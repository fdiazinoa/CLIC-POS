...
- [ ] Calcular p95 nearest-rank sorted[ceil(0.95*n)-1], n/p50/p95/max y deltas absolutos/%; no excluir outliers salvo error de captura documentado.
...
- [ ] Long Tasks >50ms, forced synchronous layout, renders React innecesarios y main-thread sync work localizados.
...
- [ ] Sin loaders artificiales/timers arbitrarios/quitar funciones/apagar sync/manipular muestras.
