...
const BulkEditModal: React.FC<BulkEditModalProps> = ({
   ...
   const [flags, setFlags] = useState({
      ...
      promptPrice: { apply: false, value: false },
      integersOnly: { apply: false, value: false },
      excludeFromPromotions: { apply: false, value: false },
      excludeFromLoyalty: { apply: false, value: false },
   });
               ...
               {activeTab === 'FLAGS' && (
                  <div className="max-w-2xl mx-auto space-y-4 animate-in slide-in-from-right-4 duration-300">
                     {[
                        ...
                        { id: 'promptPrice', label: 'Solicitar Precio al Vender', icon: DollarSign, desc: 'Preguntar precio en cada venta.' },
                        { id: 'integersOnly', label: 'Solo Cantidades Enteras', icon: Hash, desc: 'No permite fracciones (1, 2, 3).' },
                        { id: 'excludeFromPromotions', label: 'Excluir de Promociones', icon: Ban, desc: 'No aplica descuentos automáticos.' },
                        { id: 'excludeFromLoyalty', label: 'Excluir de Lealtad', icon: Tag, desc: 'No genera puntos de fidelidad.' },
                     ].map(flag => {
