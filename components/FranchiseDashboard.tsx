         ...
         <div className="bg-white rounded-3xl shadow-md border border-slate-200 overflow-hidden">
            ...
            <div className={`bg-slate-50 border-b border-slate-200 px-8 py-4 flex justify-between items-center transition-colors ${selectedContext.startsWith('GROUP:') ? 'bg-blue-50/50' : ''}`}>
               ...
               <button
                  ...
                  className={`px-6 py-2.5 rounded-xl font-bold text-white shadow-lg transition-all flex items-center gap-2 ${broadcastSuccess ? 'bg-emerald-500' : 'bg-blue-600 hover:bg-blue-700 active:scale-95'
                     }`}
               >
                  {isBroadcasting ? (
