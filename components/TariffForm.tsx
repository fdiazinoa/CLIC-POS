        ...
        <div className="flex-1 overflow-y-auto p-8 bg-gray-50">
           ...
           {activeTab === 'GENERAL' && (
              <div className="space-y-8 animate-in slide-in-from-right-4 max-w-4xl mx-auto">
                 ...
                 {/* Strategy Selection */}
                 <section>
                    <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Estrategia de Precios</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                       {[
                          ...
                          <button
                             ...
                             className={`p-6 rounded-2xl border-2 text-left transition-all flex flex-col gap-3 ${
                                formData.strategy.type === s.id 
                       ...
                       <div className="space-y-2">
                          {[
                             ...
                             <button 
                                ...
                                className={`w-full p-3 text-left rounded-xl text-sm font-medium transition-all ${
                                   formData.strategy.rounding === r.id 
