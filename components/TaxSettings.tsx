...
const TaxSettings: React.FC<TaxSettingsProps> = ({
  ...
  return (
    <div className="max-w-6xl mx-auto w-full p-4 md:p-8 pb-24 md:pb-16 animate-in fade-in">
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between mb-8">
        ...
        <button
          onClick={handleSave}
          className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-emerald-600 text-white rounded-2xl font-black shadow-lg shadow-emerald-200 hover:bg-emerald-500 active:scale-95 transition-all"
        >
          <Save size={18} />
          Guardar Cambios
        </button>
        ...
        <div className="bg-white rounded-[2rem] border border-slate-100 shadow-sm p-6 md:p-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-900 text-white font-bold hover:bg-black transition-colors"
            >
              <Plus size={16} />
              Nuevo
            </button>
