                    ...
                    <div className="bg-white rounded-2xl w-full max-w-md p-6 shadow-2xl">
                       ...
                       <div className="space-y-4">
                          ...
                          <div>
                             ...
                             <input type="text" value={userForm.photo || ''} onChange={e => setUserForm({...userForm, photo: e.target.value})} className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-indigo-500 text-xs text-gray-600" placeholder="https://..." />
                          </div>
                       </div>
                ...
                <div className="flex-1 overflow-y-auto">
                    {roles.map(role => (
                       <button
                          ...
                          className={`w-full p-4 text-left border-l-4 transition-all hover:bg-gray-50 flex items-center justify-between group ${
