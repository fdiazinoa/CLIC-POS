...
export const DEFAULT_ROLES: RoleDefinition[] = [
  {
    ...
    permissions: [
      ...
      'POS_PRICE_OVERRIDE', 'POS_OPEN_DRAWER', 'POS_RETURNS', 'POS_GATEWAY_REFUND',
  ...
  },
  {
    ...
    permissions: [
      ...
      'POS_RETURNS', 'POS_GATEWAY_REFUND', 'POS_REPRINT_RECEIPT', 'POS_NEW_SALE', 'POS_CHANGE_TARIFF'
    ],
    isSystem: true,
...
export const AVAILABLE_PERMISSIONS = [
  ...
  { key: 'POS_GATEWAY_REFUND', label: 'Procesar Refund Integrado', description: 'Ejecutar refunds del adquirente desde el historial del POS', category: 'SALES' },
