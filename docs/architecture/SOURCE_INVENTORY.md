...
| `components/LoginScreen.tsx` | 452 | `../services/BiometricAuthService`, `../types`, `../utils/interactionPerformance`, `./AccessibilityToggle`, `@capacitor/core`, `lucide-react`, `react` |
...
| `components/ModernLoginScreen.tsx` | 457 | `../services/BiometricAuthService`, `../types`, `../utils/interactionPerformance`, `./ModernLoginScreen.css`, `@capacitor/core`, `lucide-react`, `react` |
...
| `tests/masterOperationalApi.test.ts` | 90 | `../utils/masterOperationalApi`, `node:assert/strict`, `node:test` |
...
| `tests/restaurantClientConsistencyContract.test.ts` | 93 | `node:assert/strict`, `node:fs`, `node:test` |
...
| `utils/interactionPerformance.ts` | 306 | `../diagnostics/runtime` |
...
| `utils/masterOperationalApi.ts` | 88 | `@capacitor/core` |
