...
El **descuento global** de 10% se perdía después de Tickets en la APK QA. Se reprodujo exactamente en el baseline `1.1.426-profile` restaurado: RD$132.75 antes de Tickets y RD$147.50 al regresar. Es una falla preexistente, no una regresión del overlay. Durante esa comprobación apareció el aviso «Cajón Abierto Exitosamente» tras un toque; no se verificó si había cajón físico conectado y no se registró venta. El carrito de la comprobación se descartó; Venta quedó en RD$0.00. No se tocaron Sync, SQLite ni lógica de Mesas.
