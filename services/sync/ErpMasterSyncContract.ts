...
export const ERP_MASTER_COLLECTION_CONTRACT: Readonly<Record<string, ErpMasterCollectionContract>> = Object.freeze({
    ...
    productCategories: { domain: 'catalog', critical: false, supported: false },
    productGroups: { domain: 'catalog', critical: false, supported: false },
    serviceTypes: { domain: 'catalog', critical: false, supported: false },
    users: { domain: 'catalog', critical: false, supported: false },
    roles: { domain: 'catalog', critical: false, supported: false },
    productStocks: { domain: 'inventory', critical: false, supported: false },
    supplierProductPrices: { domain: 'prices', critical: false, supported: false },
    discountRules: { domain: 'promotions', critical: false, supported: false },
    promotionRules: { domain: 'promotions', critical: false, supported: false },
    promotionConditions: { domain: 'promotions', critical: false, supported: false },
    promotionBenefits: { domain: 'promotions', critical: false, supported: false },
    customerPointBalances: { domain: 'loyalty', critical: false, supported: false },
    loyaltyTiers: { domain: 'loyalty', critical: false, supported: false },
