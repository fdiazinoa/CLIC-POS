...
class ProductImageCacheService {
  ...
  private normalizeSingleIncomingProduct(
    ...
    const normalized: IncomingProduct = {
      ...
      description: Object.hasOwn(item, 'description') ? asString(item.description) : localProduct?.description || '',
      sku: Object.hasOwn(item, 'sku') ? asString(item.sku) : localProduct?.sku || '',
      external_code: Object.hasOwn(item, 'external_code') ? asString(item.external_code) : localProduct?.external_code || '',
      externalCode: Object.hasOwn(item, 'external_code') ? asString(item.external_code) : localProduct?.externalCode || '',
      reference: Object.hasOwn(item, 'external_code') ? asString(item.external_code) : localProduct?.reference || '',
      barcode: Object.hasOwn(item, 'barcode') ? asString(item.barcode) : localProduct?.barcode || '',
      barcode_2: Object.hasOwn(item, 'barcode_2') ? asString(item.barcode_2) : localProduct?.barcode_2 || '',
      barcode2: Object.hasOwn(item, 'barcode_2') ? asString(item.barcode_2) : localProduct?.barcode2 || '',
      barcode_3: Object.hasOwn(item, 'barcode_3') ? asString(item.barcode_3) : localProduct?.barcode_3 || '',
      barcode3: Object.hasOwn(item, 'barcode_3') ? asString(item.barcode_3) : localProduct?.barcode3 || '',
