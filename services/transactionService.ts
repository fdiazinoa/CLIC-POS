...
class TransactionService {
    ...
    async createTransaction(
        ...
        const transaction: Transaction = {
            ...
            customer_invoice_by_email: data.customer_invoice_by_email,
            customer_commercial_discount_rate: data.customer_commercial_discount_rate,
            customer_allowed_tariff_ids: data.customer_allowed_tariff_ids,
            customer_default_tariff_id: data.customer_default_tariff_id,
